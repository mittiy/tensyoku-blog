...
const SECTIONS: FieldSection[] = [
  {
    ...
    rows: [
      ...
      },
      {
        job: "設備保全・機械保全",
        first: "機械保全技能士3級",
        stepUp: "機械保全技能士2級／第二種電気工事士",
        articleHref: "/blog/factory/maintenance-career",
        articleLabel: "設備保全への転職ガイド",
      },
      {
        job: "半導体工場スタッフ",
        first: "資格不要（入社後に取得）",
        stepUp: "機械保全技能士／危険物取扱者 乙4",
        articleHref: "/blog/factory/semiconductor-career",
        articleLabel: "半導体工場への転職ガイド",
      },
      {
        job: "期間工",
        first: "資格不要（体力と出勤率が評価軸）",
        stepUp: "フォークリフト／QC検定（正社員登用に有利）",
        articleHref: "/blog/factory/kikanko-guide",
        articleLabel: "期間工完全ガイド",
      },
      {
        job: "溶接工",
        first: "アーク溶接特別教育（2〜3日）",
        stepUp: "溶接技能者評価試験（JIS検定）基本級→専門級",
      ...
      },
      {
        ...
        first: "資格不要（入社後OJT）",
        stepUp: "QC検定3級→2級",
        articleHref: "/blog/factory/kensa-kenpin-career",
        articleLabel: "検査・検品の仕事ガイド",
      },
    ],
  },
  {
    ...
    rows: [
      ...
      {
        job: "塗装工",
        first: "有機溶剤作業主任者（2日講習）",
        stepUp: "塗装技能士2級→1級",
        articleHref: "/blog/construction/tosou-career",
        articleLabel: "塗装工への転職ガイド",
      },
      {
        job: "造園職人",
        first: "造園技能士3級",
        stepUp: "造園技能士2級→1級／造園施工管理技士",
      ...
      {
        job: "型枠大工",
        first: "玉掛け／丸のこ等取扱い特別教育",
        stepUp: "型枠施工技能士2級→1級",
        articleHref: "/blog/construction/katawaku-daiku-career",
        articleLabel: "型枠大工への転職ガイド",
      },
      {
        job: "ビル設備管理（ビルメン）",
        first: "第二種電気工事士／危険物乙4",
        stepUp: "ビルメン4点セット→建築物環境衛生管理技術者",
